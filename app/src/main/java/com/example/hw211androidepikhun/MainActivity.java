package com.example.hw211androidepikhun;
...
//Toast.makeText(MainActivity.this, "необходимое сообщение", Toast.LENGTH_LONG).show();
    ...
    public void button_on(View view) {
        ...
        String sInputMoney =  mInputMoney.getText().toString();
        String sInputInfo =  mInputInfo.getText().toString();
        Toast.makeText(MainActivity.this, "Сумма " + sInputMoney + " переведена по  "+sInputInfo , Toast.LENGTH_LONG).show();
